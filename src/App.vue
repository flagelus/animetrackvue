...
<template>
  <main>
    ...
    <div class="results" v-if="search_results.length > 0">
      <div v-for="anime in search_results" class="result" :key="anime.id">
        ...
        <div class="details">
          ...
          <button @click="addAnime(anime)">Adicionar a lista</button>
        </div>
      </div>
    </div>
    <div class="myanime" v-if="my_anime.length > 0">
      ...
      <div v-for="anime in my_anime_asc" class="anime" :key="anime.id">
        <img :src="anime.image" />
        <h3>{{ anime.title }}</h3>
